...
function OrderedBulkOperation(collection, options) {
    ...
    // Final results
    var bulkResult = {
        ok: 1, writeErrors: [], writeConcernErrors: [], nInserted: 0, nUpserted: 0, nMatched: 0, nModified: 0, nRemoved: 0, upserted: []
    };
    ...
    var getOrderedCommand = function (_self, _namespace, _docType, _operationDocuments) {
        ...
        if (_docType == common.INSERT) {
            return {
                insert: _namespace, documents: _operationDocuments, ordered: true
            }
        } else if (_docType == common.UPDATE) {
            return {
                update: _namespace, updates: _operationDocuments, ordered: true
            };
        } else if (_docType == common.REMOVE) {
            return {
                delete: _namespace, deletes: _operationDocuments, ordered: true
            };
        }
    }
